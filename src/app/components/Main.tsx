...
export default function Main() {
    return (
        <div className="w-full">
            <div className="xl:max-w-7xl w-full mx-auto gap-x-8  flex mt-10 ">
                <div className="xl:max-w-5/12 lg:max-w-6/12 w-full md:px-10 lg:px-6 px-6 ">
                    <div className="w-full flex flex-col space-y-10 pt-12 ">
                        ...
                        <h1 className="md:text-7xl text-5xl font-bold">An Industrial Take on Streetwear</h1>
