...
export default function Newsletter() {
    return (
        <div className="w-full mt-12 ">
            <div className="xl:max-w-6xl  mx-auto relative flex flex-col justify-center items-center py-32 z-[1] px-6 md:px-10 lg:px-6 text-center">
                ...
                <form className="flex md:flex-nowrap flex-wrap justify-center items-center gap-x-4 md:gap-y-0 gap-y-4">
