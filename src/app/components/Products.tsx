...
export default async function Products() {
    ...
    // console.log(data)
    return (
        <div className="xl:max-w-6xl mx-auto  mt-16">
            ...
            {data.map((item) => (
                <div key={item._id} className="xl:max-w-lg lg:min-w-[448px] xl:min-w-[375px] md:min-w-[640px] min-w-[260px] mx-8 md:mx-0 md:ml-16 lg:ml-0  h-fit  transition duration-100 ease-in hover:scale-105">
